...
Функция ВыполнитьКоманду(Знач ПараметрыКоманды, Знач ДополнительныеПараметры = Неопределено) Экспорт
	...
	Если СохранятьОтчетВФайл Тогда
		...
		Если РезультатТестирования.Ошибки.Количество() = 0 Тогда
			ДополнитьРезультатУспешнымВыполнением(РезультатТестирования);
		КонецЕсли;
...
Процедура ДополнитьРезультатУспешнымВыполнением(Результат)
	
	Результат.КоличествоПроверок = Результат.КоличествоПроверок + 1;
	
	Описание = Новый Структура();
	Описание.Вставить("ТекстОшибки", "");
	Описание.Вставить("ИмяГруппы"  , "Синтаксическая проверка конфигурации");
	Описание.Вставить("НомерСтроки", 0);
	Описание.Вставить("ТипОшибки"  , "Исправлено");
	
	Результат.Ошибки.Вставить(Описание.ИмяГруппы, Описание);
